...
- `scena/*.clm`：本 MOD 修改范围内的 35 个完整简体中文场景脚本反编译稿，已按 NISA Steam 1.2.5、zeroTool 碧轨汉化 1.8 与 More Portraits in Azure 1.5.0 刷新。
...
`c1030.clm` 已同步 More Portraits in Azure 1.5.0 新增的珊珊头像结构；当前稿保留
100 个 `#150xxF` 头像标记，并保持现行简体中文对白。
